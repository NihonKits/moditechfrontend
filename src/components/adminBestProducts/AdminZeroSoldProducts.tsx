...
const AdminZeroSoldProducts = () => {
  const { data } = useQuery<ProductInterface[]>({
    queryKey: ["AdminZeroSoldProducts"],
    queryFn: () =>
      axios
        .get(
          `${
            import.meta.env.VITE_APP_BASE_URL
          }/api/product/getProductsWithZeroSold`
        )
        .then((res) => res.data),
  });
...
export default AdminZeroSoldProducts;
